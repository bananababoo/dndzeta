...
open class Stamp(player: Player, origin: Location, val item: ItemStack, translation: Vector3f=Vector3f(0f,0f,0f), scale: Vector3f=Vector3f(1f,1f,1f))
    ...
    override fun makeUpdateEntityDataPacket(): WrapperPlayServerEntityMetadata {
        ...
        return WrapperPlayServerEntityMetadata(id,
            listOf(
                ...
                EntityData(23, EntityDataTypes.ITEMSTACK, item),
            )
        )
    }
