...
object DatabaseActions {
    ...
    inline fun <reified T : Data> store(vararg objects: T){
        ...
        val data: MutableSet<Data> = Data.serverDataLists[T::class] ?: throw IllegalStateException("Tried to get DataList that doesn't exist (shouldn't be possible) ${T::class.simpleName}")
        data.addAll(objects)
    }
